...
const mockProduct = (rest) => {
    return Object.assign({ name: faker_1.faker.commerce.productName(), description: faker_1.faker.commerce.productDescription(), stock: faker_1.faker.number.int({ min: 10, max: 100 }), price: faker_1.faker.commerce.price() }, rest);
};
describe("catalogService", () => {
    ...
    describe("updateProduct", () => {
        ...
        test("should throw error with product doesn't exists", () => __awaiter(void 0, void 0, void 0, function* () {
            const service = new catalog_service_1.CatalogService(repository);
            jest
                .spyOn(repository, "update")
                .mockImplementationOnce(() => Promise.reject(new Error("product does not exists")));
            yield expect(service.updateProduct({})).rejects.toThrow("product does not exists");
        }));
    });
    describe("getProducts", () => {
        ...
        test("should throw error with products doest not exist", () => __awaiter(void 0, void 0, void 0, function* () {
            const service = new catalog_service_1.CatalogService(repository);
            jest
                .spyOn(repository, "find")
                .mockImplementationOnce(() => Promise.reject(new Error("products does not exists")));
            yield expect(service.getProducts(0, 0)).rejects.toThrow("products does not exists");
        }));
    });
    describe("getProduct", () => {
